...
from rl_modules.contrastive_models import (
    tanh_gaussian_actor_img,
    flatten_mlp_contrastive_img,
)
...
"""
Image-based Contrastive Learning for Goal-Conditioned Reinforcement Learning
"""


class contrastive_img_agent:
    def __init__(self, args, env, env_params):
        ...
        self.actor_network = tanh_gaussian_actor_img(
        ...
        self.critic1 = flatten_mlp_contrastive_img(
            hidden_size=hidden_size, repr_dims=64, action_dims=env_params["action"]
        ).to(self.device)
    ...
    def _update_network(self):
        ...
        random_g_norm = transitions["random_g"] / 255
    ...
    def _eval_agent(self):
        ...
        wandb.log({"Evaluated Reward": success_rate}, step=self.timesteps)
        return success_rate
